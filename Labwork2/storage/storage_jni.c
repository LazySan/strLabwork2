 ...
 * Signature: ()V
 */
JNIEXPORT jint JNICALL Java_Storage_hasPallet(JNIEnv* jniEnv, jclass jclass) {
	hasPallet();
}
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_Storage_getP2(JNIEnv* jniEnv, jclass jclass) {
	getP2();
}
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_Storage_modifyP2(JNIEnv* jniEnv, jclass jclass, jint p) {
	modifyP2(p);
}